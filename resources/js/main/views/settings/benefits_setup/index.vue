<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.benefits_setup`)" class="p-0">
            </a-page-header>
        </template>
        <template #breadcrumb>
                            ...
                            <a-tab-pane key="general_settings">
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="12" :md="8" :lg="8">
                                        <a-form-item label="Withholding Tax Process" name="withholding_tax_process">
                                            <a-select
                                                v-model:value="formData.withholding_tax_processing"
                                                style="width: 100%"
                                                placeholder="Select process"
                                            >
                                                <a-select-option value="annualize">Annualize</a-select-option>
                                                <a-select-option value="monthly">Monthly</a-select-option>
                                                <a-select-option value="s_monthly">Semi-Monthly</a-select-option>
                                    ...
                                    <a-col :xs="24" :sm="12" :md="8" :lg="8">
                                        <a-form-item label="Benefits Type" name="benefits_type">
                                            <a-select
                                                v-model:value="formData.gov_benifits"
                                                style="width: 100%"
                                                placeholder="Select benefits type"
                                            >
                                                <!-- <a-select-option value="A">A</a-select-option> -->
                                                <a-select-option value="B">End Of the month</a-select-option>
                                                <a-select-option value="s_monthly">Semi Monthly</a-select-option>
                                            </a-select>
                                        </a-form-item>
                                    </a-col>
    ...
    setup() {
        ...
        const setFormData = () => {
            formData.value = {
                ...
                withholding_tax_processing: company.withholding_tax_processing,
                gov_benifits: company.gov_benifits,
                _method: "PUT",
            };
        };
